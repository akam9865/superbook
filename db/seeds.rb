...
g2  = Game.create({ team1_id: 3, team2_id: 4, day_id: 1, odds: 1.3, sport_id: 1 })
g3  = Game.create({ team1_id: 5, team2_id: 6, day_id: 1, odds: 1.4, sport_id: 1 })
g4  = Game.create({ team1_id: 7, team2_id: 8, day_id: 1, odds: 1.6, sport_id: 1 })
g5  = Game.create({ team1_id: 9, team2_id: 10, day_id: 1, odds: 1.7, sport_id: 1 })
g6  = Game.create({ team1_id: 11, team2_id: 16, day_id: 1, odds: 1.8, sport_id: 1 })
g7  = Game.create({ team1_id: 12, team2_id: 17, day_id: 1, odds: 1.9, sport_id: 1 })
g8  = Game.create({ team1_id: 13, team2_id: 18, day_id: 1, odds: 1.0, sport_id: 1 })
g9  = Game.create({ team1_id: 14, team2_id: 19, day_id: 1, odds: 2.0, sport_id: 1 })
g10 = Game.create({ team1_id: 15, team2_id: 20, day_id: 1, odds: 2.1, sport_id: 1 })

g11  = Game.create({ team1_id: 31, team2_id: 32, day_id: 1, odds: 2.2, sport_id: 2 })
g12  = Game.create({ team1_id: 33, team2_id: 34, day_id: 2, odds: 1.5, sport_id: 2 })

g13 = Game.create({ team1_id: 38, team2_id: 40, day_id: 1, odds: 1.5, sport_id: 3 })
g14 = Game.create({ team1_id: 39, team2_id: 41, day_id: 2, odds: 1.5, sport_id: 3 })
